      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="politics">경제</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="politics">사회</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="politics">생활/문화</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="politics">세계</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="politics">it/과학</a>
            </li>
            <li class="nav-item">
